...
public class MotorcycleController {
    ...
    public ResponseEntity<Motorcycle> update(@Valid @PathVariable String license_plate, @RequestBody Motorcycle moto) {
    ...
    public ResponseEntity<Motorcycle> delete(@Valid @PathVariable String license_plate) {
